    ...
    <div class="container py-12 md:py-16">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div class="space-y-4">
                ...
                <div class="flex space-x-4">
                    <a href="https://www.tiktok.com/@panamalembu" target="_blank" class="text-muted-foreground hover:text-primary transition-colors">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-muted-foreground">
                    ...
                    <li><a href="<?php echo esc_url( home_url( '/shipping-returns' ) ); ?>" class="hover:text-primary">Shipping Policy</a></li>
                    <li><a href="<?php echo esc_url( home_url( '/returns' ) ); ?>" class="hover:text-primary">Returns & Refunds</a></li>
                    <li><a href="<?php echo esc_url( home_url( '/terms-of-service' ) ); ?>" class="hover:text-primary">Terms of Service</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="mt-6 pt-6 border-t border-zinc-800">
                    <div class="flex flex-wrap items-center gap-6 opacity-60 hover:opacity-100 transition-all duration-500">
                        <div class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-zinc-400"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/></svg>
                            <span class="text-[10px] font-black tracking-widest uppercase text-zinc-400">Plaid Secured</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-zinc-400"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
                            <span class="text-[10px] font-black tracking-widest uppercase text-zinc-400">Crypto (BTC/ETH)</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-12 pt-8 border-t border-zinc-800 flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div class="flex items-center gap-4">
                <div class="px-3 py-1 border border-zinc-800 rounded text-[10px] text-zinc-500 font-bold uppercase tracking-tighter">SECURE PLAID LINK</div>
