...
<div class="bg-primary text-white py-3 px-4 text-center border-b border-white/10">
    <div class="container">
        <p class="text-[10px] md:text-xs font-black tracking-[0.15em] uppercase leading-relaxed">
            <span class="bg-white text-primary px-2 py-0.5 rounded mr-2">Mandatory Regulatory Disclosure</span>
...
<header id="main-header" class="sticky top-0 z-50 w-full bg-white/90 backdrop-blur-md pink-metallic-glow border-b border-zinc-100 transition-transform duration-300">
    <div class="container flex h-24 items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            <div class="hidden lg:flex items-center mr-4">
                <?php echo helivex_get_account_link(); ?>
            </div>
