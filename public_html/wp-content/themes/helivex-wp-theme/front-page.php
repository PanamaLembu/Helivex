        ...
        <div class="absolute inset-0 z-0 overflow-hidden">
            ...
            <div class="absolute inset-0 z-0">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/freezervials.jpg" 
                     ...
                     class="w-full h-full object-cover object-right opacity-20">
            </div>
        ...
        <div class="container relative z-10 text-zinc-900">
            <div class="flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                <div class="relative hidden md:block">
                    <div class="w-80 h-80 md:w-[450px] md:h-[450px] animate-float-slow animate-pulse-slow hover:scale-110 transition-transform duration-700 cursor-pointer">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" 
                             alt="Helivex Labs Logo" 
                             class="w-full h-full object-contain drop-shadow-[0_0_30px_rgba(139,26,26,0.2)]">
                    </div>
                    <!-- Decorative Ring -->
                    <div class="absolute inset-0 border-2 border-primary/10 rounded-full scale-110 animate-ping opacity-20 pointer-events-none"></div>
                </div>
            </div>
        </div>
                    ...
                    <div id="dot3" class="vial-dot absolute group/dot3 z-30 -translate-x-1/2 -translate-y-1/2" style="top: <?php echo $saved_positions['dot3']['top']; ?>; left: <?php echo $saved_positions['dot3']['left']; ?>;">
                        <div class="relative">
                            ...
                            <div class="absolute top-full left-1/2 -translate-x-1/2 mt-8 w-64 p-5 bg-white/95 backdrop-blur-md border border-black/5 rounded-2xl shadow-2xl opacity-0 scale-90 pointer-events-none group-hover/dot3:opacity-100 group-hover/dot3:scale-100 group-hover/dot3:pointer-events-auto transition-all duration-300">
                                <div class="text-[9px] font-black text-primary uppercase tracking-[0.2em] mb-1.5">COA Consistency</div>
                                <div class="text-[13px] text-zinc-600 leading-relaxed font-medium">We ensure current COAs are always available for every batch we synthesize.</div>
            ...
            <div class="flex flex-col lg:flex-row gap-20 items-center">
                ...
                <div class="w-full lg:w-1/2 space-y-12">
                    <div class="space-y-6">
                        ...
                        <p class="text-[10px] text-zinc-400 italic uppercase tracking-widest">
                            * Analysis reflects sample COA qualities and does not refer to a specific product batch.
                        </p>
                    </div>
