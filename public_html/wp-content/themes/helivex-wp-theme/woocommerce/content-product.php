...
<div <?php wc_product_class( 'group flex flex-col h-full bg-white rounded-2xl border border-border overflow-hidden transition-all hover:shadow-xl hover:shadow-primary/5 hover:border-primary/20 pink-metallic-glow', $product ); ?>>
    <!-- Image Section -->
    <a href="<?php the_permalink(); ?>" class="aspect-[4/5] relative bg-zinc-50 overflow-hidden flex items-center justify-center p-8 flex-shrink-0">
