    ...
    <div class="max-w-4xl mx-auto space-y-16">
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div class="space-y-6">
                ...
                <p class="text-zinc-600 leading-relaxed">
                    We ensure 99%+ purity by utilizing state-of-the-art laboratory analysis from industry leaders including Janoshik, Freedom, Chromate, and Vanguard. Every vial is subjected to rigorous HPLC and Mass Spectrometry testing to maintain our uncompromising standards.
                </p>
            </div>
