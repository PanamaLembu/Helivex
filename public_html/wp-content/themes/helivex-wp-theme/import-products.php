...
function helivex_import_products_from_csv() {
    ...
    while (($data = fgetcsv($handle)) !== FALSE) {
        ...
        if ($is_ez) {
            ...
            $descriptions = [
                'SM' => 'A potent GLP-1 receptor agonist utilized in clinical research to study glycemic regulation and metabolic appetite control pathways.',
                'TRZ' => 'A dual GIP and GLP-1 receptor agonist engineered for advanced study of synergistic metabolic signaling and energy homeostasis.',
                'RT' => 'A triple agonist (GLP-1, GIP, and glucagon receptors) for experimental analysis of multi-pathway metabolic enhancement.',
