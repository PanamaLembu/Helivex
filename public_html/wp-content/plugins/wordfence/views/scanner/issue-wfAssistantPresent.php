...
echo wfView::create('scanner/issue-base', array(
	...
	'detailPairs' => [
		...
		null,
		__("Details", "wordfence") => sprintf(/* translators: Help URL. */__('${longMsg} <a href="%s" target="_blank">Click here to learn more. <span class="screen-reader-text">(opens in new tab)</span></a>', "wordfence"), "https://www.wordfence.com/help/scan/scan-results/#assistant-plugin-removed"),
	],
	'detailControls' => [],
