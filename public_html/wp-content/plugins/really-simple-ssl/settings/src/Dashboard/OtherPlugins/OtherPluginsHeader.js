        ...
        <>
            ...
            <div className="rsssl-grid-item-controls">
                <span className="rsssl-header-html">
                    <a className="rsp-logo" href="https://really-simple-ssl.com/about-us"><img src={rsssl_settings.plugin_url+"assets/img/really-simple-plugins.svg"} alt="Really Simple Plugins"/></a>
                </span>
            </div>
        </>
    )
