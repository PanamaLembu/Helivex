...
= 8.8.1 =
**CRITICAL FIX:** Resolves a valid PHP Fatal Error during AbuseIPDB rate limiting. Fixes XML-RPC issues with MarsEdit.

= 8.8.0 =
**MAJOR REFACTOR:** The plugin has been modernized with a modular architecture for better performance and stability. Includes optimized JavaScript loading and centralized background task scheduling.